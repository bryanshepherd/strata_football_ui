...
const stepCopy = {
  ...
  fieldGoalNextSpot: {
    ...
    helper: 'Confirm or change the previous line of scrimmage to the officials’ awarded spot.',
    placeholder: 'V20',
  },
  patType: {
    title: 'PAT Type',
...
const gameControlMenuButtons = [
  ...
  { label: 'Participation', hotkey: 'I', value: 'I' },
...
function stepCopyForState(state, aliases, teamNames) {
  ...
  if (state.tokens?.kickMenuSelection === 'fieldGoal') {
    ...
    if (step === 'fieldGoalNextSpot') {
      ...
      return {
        ...copy,
        helper: `Confirm where ${teamNames?.[team] || (team === 'H' ? 'Home' : 'Visitor')} will begin its possession. The previous line of scrimmage is prefilled; change it to the officials’ awarded spot if needed.`,
