...
await build({
  stdin: {
    contents: "export { repairFootballEditedActorsInEnvelope, repairFootballPlayReadoutsInEnvelope } from './src/play-editor/footballPlayEditEnvelope.js'; export { formatFootballChallengeReadout } from './src/utils/footballChallengeReadout.js'; export { footballCoinTossLines } from './src/utils/footballCoinTossReadout.js';",
